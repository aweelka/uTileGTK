...
extern const char* TileGtk_InitialiseSymbols_gdk(const char *file_name);
#define TILEGTK_LAST_SYMBOL_gdk TileGtk_gdk_x11_screen_lookup_visual
extern const char* TileGtk_InitialiseSymbols_gdk_pixbuf(const char *file_name);
#define TILEGTK_LAST_SYMBOL_gdk_pixbuf TileGtk_gdk_pixbuf_unref
extern const char* TileGtk_InitialiseSymbols_gdk_pixbuf_xlib(const char *file_name);
#define TILEGTK_LAST_SYMBOL_gdk_pixbuf_xlib TileGtk_xlib_rgb_init
extern const char* TileGtk_InitialiseSymbols_glib(const char *file_name);
#define TILEGTK_LAST_SYMBOL_glib TileGtk_g_strfreev
extern const char* TileGtk_InitialiseSymbols_gobject(const char *file_name);
#define TILEGTK_LAST_SYMBOL_gobject TileGtk_g_object_unref
extern const char* TileGtk_InitialiseSymbols_gtk(const char *file_name);
